...
Dispatch `catalog-identifier` with the lines `point: review`, each framework the project declares,
and the project folder. Then dispatch it again with `point: test-execution` and each
