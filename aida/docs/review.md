...
with no automated tests, a criterion owned by an order you confirm is yours to answer too. Its
rows are that order's done-when sentences, and you answer met or unmet for the criterion.
