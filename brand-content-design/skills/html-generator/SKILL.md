---
name: html-generator
description: "Use when generating branded HTML pages, landing pages, or web components from a design system. Creates standalone HTML components with BEM CSS and composes them into responsive single-file pages with embedded styles, design tokens, WCAG AA accessibility, and metadata comments for framework conversion. Use when user says 'create HTML page', 'make landing page', 'web page', 'website', 'UI components', or 'styled HTML'."
version: 2.9.0
