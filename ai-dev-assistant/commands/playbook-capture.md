...
```
/ai-dev-assistant:playbook-capture                                # ask user to describe
/ai-dev-assistant:playbook-capture "Use BEM mod-* for utilities"  # short description hint
```
...
> Refuse with: "No user playbook configured for this project. Run `/ai-dev-assistant:set-user-playbook` first."
...
- `/ai-dev-assistant:playbook-review` — walk existing plays for keep/update/remove
