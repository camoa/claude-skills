...
```bash
/ai-dev-assistant:migrate-tasks
```
...
2. **Downgrade plugin:**
   ```bash
   /plugin install ai-dev-assistant@2.1.0@camoa-skills
   ```

## FAQ

**Q: Can I use v3.0.0 with existing v2.x projects?**
A: No, you must migrate tasks first using `/ai-dev-assistant:migrate-tasks`
...
- **Tag:** `ai-dev-assistant` and `migration`

## Summary

1. ✅ Backup projects
2. ✅ Install v3.0.0
3. ✅ Run `/ai-dev-assistant:migrate-tasks`
4. ✅ Verify migration
