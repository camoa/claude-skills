...
- `ai-dev-assistant`'s `/implement` writes git refs into the repository at
  `codePath`, under `refs/worktree/aida/build-checkpoints/`. That is a write into a tree
