...
- `/drupal-dev-framework:scope` — read current state to decide overwrite/edit/cancel
- `/drupal-dev-framework:research` — pre-analysis hook checks whether `alignment.md` already exists; Phase 1 sub-step appends Phase 1 section
- `/drupal-dev-framework:design` — Phase 2 sub-step appends Phase 2 section
- `/drupal-dev-framework:implement` — Phase 3 sub-step appends Phase 3 section
- `/drupal-dev-framework:complete` — (future) may surface unchecked success criteria
