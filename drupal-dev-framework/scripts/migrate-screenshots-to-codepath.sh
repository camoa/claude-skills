...
#   <codePath>               the Drupal project root (migration target)
...
#   3. baseline PNG : <component>-1-visual-chromium-<size>-linux.png
...
test.describe('$component visual regression', () => {
  test('visual regression', async ({ page }) => {
    ...
    await takeAccessibleScreenshot(page, '$component');
  });
});
STUB
    spec_created=true
