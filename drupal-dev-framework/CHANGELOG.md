...
### Changed
- Improved `guide-loader` skill — better description, structured output format, cross-reference prerequisites step (community contribution by @rohan-tessl, PR #104)
