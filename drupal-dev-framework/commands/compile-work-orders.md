...
```
/drupal-dev-framework:compile-work-orders <task-name>
```
...
- `/drupal-dev-framework:worktree` — sets `codePath` (run before compiling).
- `/drupal-dev-framework:design` — Phase 2; produces the artifacts this command consumes.
